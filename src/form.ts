...
// }
// const patientDataSales: TPRXPatient = {
// 	fname: '',
// 	lname: '',
// 	mname: '',
// 	dob: '',
...
// const doctorDataSales: TPRXDoctor = {
// 	fname: '',
// 	mname: '',
// 	lname: '',
// 	email: '',
...
// 	country: 'USA',
// };
// const doctor2DataSales: TPRXDoctor = {
// 	fname: '',
// 	mname: '',
// 	lname: '',
// 	email: '',
...
// 			(doctorDataSales as any)[field] = data.value;
// 			if (field === 'office') {
// 				doctorDataSales['Facility_Name__c'] = data.value;
// 				return;
// 			}
// 			if (field === 'officephone') {
// 				doctorDataSales.Phone = data.value;
// 				return;
// 			}
// 			return;
// 		}
...
// 			if (field === 'office') {
// 				doctor2DataSales['Facility_Name__c'] = data.value;
// 				return;
// 			}
// 			if (field === 'officephone') {
// 				doctor2DataSales.Phone = data.value;
// 				return;
// 			}
// 			return;
// 		}
...
// 			patientDataSales['dob'] = `${month}`;
// 			return;
// 		}
// 		if (data.field === 'marital') {
// 			patientDataSales.marital = data.value;
// 			return;
// 		}
// 		if (data.field === 'employed') {
// 			patientDataSales.employed = data.value;
// 			return;
// 		}
// 		if (data.field === 'patwages') {
// 			patientDataSales.Patwages__c = parseFloat(data.value.split('$')[1]);
// 			return;
// 		}
// 		if (data.field === 'day' || data.field === 'year') {
// 			patientDataSales['dob'] = `${patientData['dob']}-${data.value}`;
// 			return;
// 		}
// 		if (data.field === 'disabled') {
// 			(patientDataSales as any)[data.field as keyof TPRXPatient] =
...
// 			(patientDataSales as any)['phone'] = data.value.replace(/-/g, '');
// 			return;
// 		}
...
// 			(patientDataSales as any)['insurance'] = data.value;
// 			return;
// 		}
// 		if (data.field.includes('segment-field')) {
// 			patientDataSales['medicationType'] = data.value;
// 		}
// 		(patientDataSales as any)[data.field as keyof TPRXPatient] = data.value;
// 	});
// 	const dateParts = patientDataSales['dob'].split('-');
// 	patientDataSales['dob'] = `${dateParts[2]}-${dateParts[1]}-${dateParts[0]}`;
...
// 	sessionStorage.setItem('formDataSales', JSON.stringify(formDataSales));
